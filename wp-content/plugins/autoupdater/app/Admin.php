...
class AutoUpdater_WP_Admin
{
    ...
    protected $configuration_file = false;
    ...
    public function displayConfigurationPage()
    {
        if (!$this->configuration_file) {
            wp_redirect('https://my.wpengine.com/products/smart_plugin_manager', 301);
            exit;
        }
    ...
    public function ajaxSaveConfiguration()
    {
        ...
        $settings = array(
            ...
            'vrt_css_exclusions' => isset($_POST['vrt_css_exclusions']) ? stripslashes((string) $_POST['vrt_css_exclusions']) : '',
        );
